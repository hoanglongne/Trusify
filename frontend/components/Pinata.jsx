...
function Pinata({contract}) {
  ...
  return (
    <form className="flex justify-center gap-6 h-[80vh] w-full mx-36 my-10" onSubmit = {sendFileToIPFS} > 

      <div className="flex-1 flex flex-col rounded-xl justify-center items-center bg-[#FAFFFE] border-2 border-[#7E9996] border-dashed h-[80%]">
        ...
        <label className="cursor-pointer font-urbanist text-[14px] bg-[#7E9996] p-4 text-white flex items-center justify-center rounded-3xl" htmlFor="inputTag">
          Select Images
          <input className="hidden" id="inputTag" type="file"  onChange = {handleImgChange} required/>   
        </label>
      </div>
